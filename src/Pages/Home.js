...
function Home() {
  return (
    <>
      ...
      <div className="Home__SectionListContainer">
        <SectionList process={process[3]} volArray={[...volList]} />
        <SectionList process={process[5]} volArray={[...volList]} />
        <SectionList process={process[6]} volArray={[...volList]} />
      </div>
    </>
  );
}
